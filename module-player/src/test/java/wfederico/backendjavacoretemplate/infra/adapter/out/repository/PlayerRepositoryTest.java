...
class PlayerRepositoryTest {
    ...
    void findById_returnsPlayerWhenExists() {
        PlayerEntity player = PlayerEntity.builder()
                ...
                .position("Winger").alterPosition("Midfielder").build();
    ...
    void findById_returnsEmptyWhenNotExists() {
        assertThat(playerRepository.findById(999L)).isEmpty();
    }
    ...
    void save_playerWithTeamRelationship() {
        ...
        PlayerEntity player = PlayerEntity.builder()
                .firstName("Lionel").lastName("Messi")
                .position("Forward").alterPosition("Midfielder").team(team).build();
        PlayerEntity saved = playerRepository.save(player);
        entityManager.flush();
        entityManager.clear();
